...
<!--Poduct Detail-->
    <div class="container">
        ...
        <div class="card mb-3">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="./assets/img/bg3.jpg" style="height:300px;" class="img-fluid" alt="post">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <div class="rating ">
                            <div class="stars" style="font-size: x-large;"> <span class="fa fa-star checked"></span> <span
                                    class="fa fa-star checked"></span>
                                <span class="fa fa-star checked"></span> <span class="fa fa-star"></span> <span
                                    class="fa fa-star"></span>
                            </div>
                            <h2 class="card-title">Hoa tulip</h2>
                            <h3 class="price text-danger">210.000vnd</h3>
                            <p class="card-text" style="font-size: 20px;">Hoa tulip có tên khoa học là Tulipa, là một loài cây thuộc chi thực vật
                                có hoa thuộc họ Liliaceae.</p>
        ...
        <div>
            ...
            <div class="row row-cols-lg-4 g-2 g-lg-3">
                <div class="col">
                    <div class="card">
                        <img src="./assets/img/bg.jpg" class="card-img-top" alt="product">
                        <div class="card-body">
                            <div class="rating">
                                ...
                                <h4 class="price text-danger">210.000vnd</h4>
                                <p class="card-text">Hoa tulip có tên khoa học là Tulipa, là một loài cây thuộc chi thực vật
                                    có hoa thuộc họ Liliaceae.</p>
                                <div class="row">
                                    <div class="col-6">
                                        <a href="#" class="btn btn-danger d-md-block "><i class="fa-solid fa-cart-shopping"></i></a>
                ...
                <div class="col">
                    <div class="card">
                        <img src="./assets/img/tl9.jpg" class="card-img-top" alt="product">
                        <div class="card-body">
                            <div class="rating">
                                <div class="stars"> <span class="fa fa-star checked"></span> <span
                                        class="fa fa-star checked"></span>
